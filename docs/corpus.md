...
```bash
python tools/enrich_corpus.py data/packages/palabras-v0.5.1-licensed.1/lexidex.sqlite --package-version 0.5.1-licensed.1
python tools/enrich_corpus.py data/packages/palabras-v0.5.1-licensed.1/lexidex.sqlite --categories --package-version 0.5.1-licensed.1
```
